    ...
    return (
        <form className="loginForm" onSubmit={submit}>
            <label className="floating-label">
                ...
                <input className="input validator w-80" type="email" value={data.email} onChange={e => setData('email', e.target.value)} required placeholder="Your Email" disabled={processing}></input>
            </label>
            <label className="floating-label">
                <span>Password</span>
